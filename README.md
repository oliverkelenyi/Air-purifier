...
| 120mm fan | 2 | Fan | 120mm PC fan | used is enough, price can change | used is enough, price can change | used is enough, price can change | used is enough, price can change | used is enough, price can change | used is enough, price can change | used is enough, price can change | https://www.google.com/search?q=120mm+pc+fan |
| USB cable | 1 | USB cable | USB cable | used is enough, price can change | used is enough, price can change | used is enough, price can change | used is enough, price can change | used is enough, price can change | used is enough, price can change | used is enough, price can change | used is enough, price can change |
...
3. The holes on the side from top to bottom: 1.swich, 2.USB-C, 3.USB cable. Follow the assembly as shown in the linked video. (For HC reviewer: I didn't get the money yet to buy the components to make[...]
...
You have to adjust the output from the booster module to 12 V (it has a built-in potentiometer for this).
